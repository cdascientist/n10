...
// scroll/interaction behaviour wired imperatively in effects.js.
// NOTE: initEffects() is NOT called from a React effect — it runs once from
// main.jsx after render (React's passive-effect machinery re-invoked it).
...
<section className="scene" data-bg="#FFFFFF" data-ink="dark" id="movement">
  <div className="wrap scene-in">
    <div className="art tilt">
      <div className="duo">
        <img className="shot" src="https://images.unsplash.com/photo-1761035190790-aa1a3472f7fc?fm=jpg&q=76&w=1600&auto=format&fit=crop" alt="People practicing yoga together in a studio" decoding="async" referrerpolicy="no-referrer" />
  ...
  <div className="wrap scene-in">
    <div className="grid">
      <div className="card wide rv tilt">
        <div className="bg"><img className="shot" src="https://images.unsplash.com/photo-1696841212541-449ca29397cc?fm=jpg&q=76&w=1200&auto=format&fit=crop" alt="" aria-hidden="true" decoding="async" referrerpolicy="no-referrer" /><span className="tone"></span><span className="fade"></span></div>
      ...
      <div className="card rv d-3 tilt">
        <div className="bg"><img className="shot" src="https://images.unsplash.com/photo-1730207375825-d734728f877e?fm=jpg&q=76&w=1200&auto=format&fit=crop" alt="" aria-hidden="true" decoding="async" referrerpolicy="no-referrer" /><span className="tone"></span><span className="fade"></span></div>
...
<section className="scene" data-bg="#8B2BFF" data-ink="light" id="book">
  <div className="wrap scene-in">
    <div className="close-in">
      <img src="https://images.unsplash.com/photo-1741552205317-817c8c9a4016?fm=jpg&q=76&w=1800&auto=format&fit=crop" alt="" aria-hidden="true" decoding="async" referrerpolicy="no-referrer" />
      <div className="veil"></div>
      <div className="inner">
