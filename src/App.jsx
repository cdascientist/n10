...
<section className="scene" data-bg="#FFFFFF" data-ink="dark" id="heat">
  <div className="wrap scene-in">
    <div className="art tilt">
      <div className="duo">
        <img className="shot" src="https://images.unsplash.com/photo-1717356495389-6ab1e5ff9d84?fm=jpg&q=76&w=1400&auto=format&fit=crop" alt="The wood-lined interior of a sauna cabin" decoding="sync" referrerpolicy="no-referrer" />
...
<section className="scene" data-bg="#FFFFFF" data-ink="dark" id="movement">
  <div className="wrap scene-in">
    <div className="art tilt">
      <div className="duo">
        <img className="shot" src="https://images.unsplash.com/photo-1761035190790-aa1a3472f7fc?fm=jpg&q=76&w=1600&auto=format&fit=crop" alt="People practicing yoga together in a studio" decoding="sync" referrerpolicy="no-referrer" />
