  ...
  return (
    ...
    <svg style={{display:"none"}} aria-hidden="true">
      <defs>
        ...
        {/* black→purple gradient — used by the #mark-bp header logo mark (Nav/Logo, src/components/chrome/Nav/Logo/index.jsx) */}
      ...
      {/* header variant — same slashes on the black→purple gradient (Nav/Logo, src/components/chrome/Nav/Logo/index.jsx) */}
